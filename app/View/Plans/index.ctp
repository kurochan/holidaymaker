    ...
    <div class="span9 offset1">
        <table class="table table-bordered" style="border:1px solid gray;">
            ...
            <?php foreach ($plan as $p){ ?>
                ...
                <td width="80%"><div class="span1 badge badge-warning" align="center"><font size="+0">費用</font></div><div align="center" ><?php echo $p['money'].'円'; ?> </div></td><tr>
                <td width="80%"><div class="span1 badge badge-success" align="center"><font size="+0">一言</font></div><div align="center"><?php echo $p['text']; ?> </td></div><tr>
				...
				?>
				<tr><td width="20%" ></td>
                <td width="80%"> <div align="center"><img src="<?php echo $this->webroot ?>img/spot/rs_<?php echo $p['image'] ?>" /></div></td><tr>
                <?php }?>
